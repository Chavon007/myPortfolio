        ...
        <div className="aboutcontent">
          ...
          <div className="aboutcontent-writeup">
            <div className="aboutcontent-writeup1">
              ...
              <p>
                I am Salvation, a Full-Stack Web Developer who
                doesn’t just write code. I architect, build, and ship
                high-performance web solutions that speak for themselves.
              </p>{" "}
              <p>
                ...
                specialize in turning complex ideas into responsive, functional,
                and user-driven digital experiences.
              </p>{" "}
              <p>
                Every project I touch is built with precision, bold energy, and
                zero shortcuts. I work across the stack with confidence, from
                API architecture to pixel-perfect frontends.
              </p>
            </div>
          ...
          <div className="whatIDo">
            ...
            <ul>
              <li>
                ...
                <small>
                  I build modern, dynamic, and responsive UIs from scratch using
                  HTML, CSS, JavaScript, TypeScript, React, Next.js, and
                  Tailwind CSS.
                </small>
              </li>
              <li>
                ...
                Backend Development:
                <small>
                  I develop fast, secure, and scalable server-side applications
